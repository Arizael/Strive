...
import de.arizael.strive.abilities.Charge;
import de.arizael.strive.abilities.EnemyStrike;
import de.arizael.strive.abilities.Stomp;
import de.arizael.strive.graphics.SpawnEmitter;
...
public class Enemy extends Mob implements IRenderable {
  ...
  public boolean canCollideWith(final ICollisionEntity otherEntity) {
    return !(otherEntity instanceof DecorMob) && !(otherEntity instanceof Enemy);
  }
}
